...
export default function CurrentCondition (props) {
  return (
    <div className="city-info">
      ...
      <h3 className="date">
      {props.currForecast.date.weekday}, 
      {props.currForecast.date.monthname_short}. 
      ...
      Projected high: {props.currForecast.high.fahrenheit}°</h3>
      <h3 className="current-design"> 
      Projected Low: {props.currForecast.low.fahrenheit}°</h3>
      <h3 className="current-design"> 
      Your summary: {props.summary}</h3>
    </div>
  );
}
